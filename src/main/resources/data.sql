INSERT INTO user_auth (name, email, password) VALUES ('システム管理者', 'info@aaa.co.jp', 'himitu');
INSERT INTO user_auth (name, email, password) VALUES ('田中一郎', 'tanaka@aaa.co.jp', 'himitu');
